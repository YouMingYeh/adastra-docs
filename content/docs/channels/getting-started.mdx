...
點選「繼續」後點選「創建團隊」，就可以完成團隊的創建了！

最後，我們需要設定 LINE 官方帳號的 Webhook URL，以啟用 Adastra AI 自動回覆功能，請回到[LINE Developers](https://developers.line.biz/console/)，點選「Messaging API」，然後點選「Webhook URL」，請找到「Webhook URL」並填入您的 LINE 官方帳號的 Webhook URL（會在創建團隊後顯示於畫面上），您可以在 Adastra 的 LINE 官方帳號設定頁面找到您的 Webhook URL，填入後點選「Update」按鈕，在點選「Verify」按鈕，如以下畫面：

![LINE 官方帳號 Webhook URL 設定畫面](./webhook-url.png)

最後，開啟「Use Webhook」開關，您就完成了 LINE 官方帳號的設定！
